...
import { UserPeopleAction, UserPeopleActionTypes } from '../../types/store/userPeople.store.type'
...
export const getUserPeople =
   (userId: string, type: string, page: number, limit: number) => async (dispatch: any) => {
